...
var app = (function () {
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(131:8) {#each routeLinks as link}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(div4, "click", /*click_handler*/ ctx[6], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ("navLinks" in $$props) navLinks = $$props.navLinks;
    		if ("routeLinks" in $$props) $$invalidate(1, routeLinks = $$props.routeLinks);
    		if ("currentPage" in $$props) $$invalidate(0, currentPage = $$props.currentPage);
    	};
    ...
    class Header extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*currentPage*/ ctx[0] === undefined && !("currentPage" in props)) {
    			console_1.warn("<Header> was created without expected prop 'currentPage'");
    		}
    	}
    ...
    const file$2 = "src/components/Jumbotron.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			img = element("img");
    			attr_dev(h1, "class", "svelte-1l3z143");
    			add_location(h1, file$2, 64, 4, 1093);
    			attr_dev(p, "class", "svelte-1l3z143");
    			add_location(p, file$2, 65, 4, 1126);
    			attr_dev(div0, "class", "jumbotron svelte-1l3z143");
    			add_location(div0, file$2, 63, 2, 1065);
    			attr_dev(img, "width", "100%");
    			if (img.src !== (img_src_value = "./images/home-image.jpg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			attr_dev(img, "class", "svelte-1l3z143");
    			add_location(img, file$2, 72, 4, 1321);
    			attr_dev(div1, "class", "image svelte-1l3z143");
    			add_location(div1, file$2, 71, 2, 1297);
    			attr_dev(div2, "class", "container svelte-1l3z143");
    			add_location(div2, file$2, 62, 0, 1039);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Button extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { color: 0, disabled: 1 });
    ...
    class ProgressBar extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$6, create_fragment$6, safe_not_equal, { progress: 0 });
    ...
    // (46:1) <Button disabled={isRunning} on:click={() => startTimer()} color="red">
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(46:1) <Button disabled={isRunning} on:click={() => startTimer()} color=\\\"red\\\">",
    		ctx
    	});
    ...
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(49:0) <Button disabled={!isRunning} on:click={() => (stoped = true)}>",
    		ctx
    	});
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-1sj74pj");
    			add_location(h2, file$6, 39, 2, 760);
    			attr_dev(div0, "bp", "grid");
    			add_location(div0, file$6, 38, 0, 742);
    			attr_dev(div1, "class", "btns svelte-1sj74pj");
    			add_location(div1, file$6, 44, 0, 861);
    			attr_dev(div2, "class", "container");
    			add_location(div2, file$6, 37, 0, 718);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-13ttvtw");
    			add_location(h1, file$7, 16, 0, 209);
    			...
    			attr_dev(img, "class", "svelte-13ttvtw");
    			add_location(img, file$7, 21, 2, 281);
    			attr_dev(div0, "bp", "margin-top--lg grid");
    			add_location(div0, file$7, 20, 0, 248);
    			attr_dev(a, "href", "https://www.who.int/gpsc/clean_hands_protection/en/");
    			add_location(a, file$7, 26, 2, 413);
    			attr_dev(div1, "bp", "margin-top--lg");
    			add_location(div1, file$7, 25, 0, 385);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
